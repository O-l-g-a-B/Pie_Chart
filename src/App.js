  ...
  render() {
    return ( 
      <div className = "App">
        {
          heroes.map((hero) =>
            <Hero name={hero.name} id={hero.id} universe={hero.universe} alter_ego={hero.alter_ego} occupation={hero.occupation} friends={hero.friends} superpowers={hero.superpowers} url={hero.url} more={hero.more}></Hero>
          )
        }
      </div>
    );
